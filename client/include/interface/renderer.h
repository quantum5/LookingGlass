...
typedef void         (* LG_RendererDMACallback)(void * opaque);
...
typedef bool         (* LG_RendererOnFrameFormat)(void * opaque, const LG_RendererFormat format, bool useDMA, LG_RendererDMACallback dmaCallback, void * dmaOpaque);
